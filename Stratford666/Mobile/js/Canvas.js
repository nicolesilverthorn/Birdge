...
//	spriteAtlas.src = "images/Animation.png";
	...
	//Objects 
		...
		//Helenas Legs
		_hLegs._spriteAnimation.init(spriteAtlas, 94, 94, 402, 2, 128); //Helena idle frame
		_hLegs._spriteAnimation.x = _player_START_X + 240;
		_hLegs._spriteAnimation.y  = _helena_START_Y - 60;


		//Helenas Legs
		_eLegs._spriteAnimation.init(spriteAtlas, 94, 94, 401, 2, 128); //Helena idle frame
		_eLegs._spriteAnimation.x = _player_START_X + 240;
		_eLegs._spriteAnimation.y  = _helena_START_Y - 60;
		...
		_player2._spriteAnimation.init(spriteAtlas, 94, 94, 300, 90, 128); //Eli Base Frames
	//	_player2._spriteAnimation.init(spriteAtlas, 94, 94, 301, 390, 128); //
		...
		//player facing back
		_chucky._spriteAnimation.init(spriteAtlas, 94, 94, 210, 90, 128); //Carlos idle frame
		//_chucky._spriteAnimation.init(spriteAtlas, 94, 94, 150, 209, 128); //right idle frame
		_chucky._spriteAnimation.x = _player_START_X + 189;
		_chucky._spriteAnimation.y  = _player_START_Y - 40;

		_helena._spriteAnimation.init(spriteAtlas, 94, 94, 120, 90, 128); //Helena idle frame
		_helena._spriteAnimation.x = _helena_START_X + 90 ;
