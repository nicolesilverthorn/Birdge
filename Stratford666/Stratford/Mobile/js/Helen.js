$(document).ready(function()
{
	...
	backgroundImage.src = "images/AnimationBackgroundE.png";
...
//load sprites
	...
	function gameLoaded()
	{
		this.timer = 745;
			...
			//bombz
		_bomb._spriteAnimation.init(spriteAtlas, 94, 94, 30, 9, 228); //Helena idle frame
		_bomb._spriteAnimation.x = _player_START_X + 350;
		_bomb._spriteAnimation.y  = _player_START_Y - 90;
		
		
		//fireworks
		_bomb2._spriteAnimation.init(spriteAtlas, 94, 94, 40, 6, 228); //Helena idle frame
		_bomb2._spriteAnimation.x = _player_START_X + 252;
		_bomb2._spriteAnimation.y  = _player_START_Y - 46;
		
		
		_bomb3._spriteAnimation.init(spriteAtlas, 94, 94, 40, 6, 128); //Helena idle frame
		_bomb3._spriteAnimation.x = _player_START_X + 650;
		_bomb3._spriteAnimation.y  = _player_START_Y - 90;
		
		
		_bomb4._spriteAnimation.init(spriteAtlas, 94, 94, 30, 4, 128); //Helena idle frame
		...
		_player._spriteAnimation.y  = _player_START_Y - 60;
