$(document).ready(function()
{
	...
	spriteAtlas.src = "images/EliSheet.png";
	spriteAtlas.addEventListener("load", assetLoaded, false);
	_assetsToLoad.push(spriteAtlas);
	
	var backgroundImage = new Image();
	backgroundImage.src = "images/AnimationBackgroundEli.png";
	...
	//update anim code here
		...
		if(_walkRight)
		{
			...
			_player._spriteAnimation.init(spriteAtlas, 94, 94, 0, 10, 148);  //walk right
	...
	function gameLoaded()
	{
		...
		_godzilla._spriteAnimation.init(spriteAtlas, 94, 94, 10, 4, 128); //Toshi Left idle frame
		...
		//fireworks
		_bomb2._spriteAnimation.init(spriteAtlas, 94, 94, 10, 4, 128); //Helena idle frame
		_bomb2._spriteAnimation.x = _player_START_X + 252;
		_bomb2._spriteAnimation.y  = _player_START_Y - 46;
		
		
		_bomb3._spriteAnimation.init(spriteAtlas, 94, 94, 10, 4, 128); //Helena idle frame
		_bomb3._spriteAnimation.x = _player_START_X + 650;
		_bomb3._spriteAnimation.y  = _player_START_Y - 90;
		
		//Dante
		_bomb4._spriteAnimation.init(spriteAtlas, 94, 94, 14, 7, 228); //Helena idle frame
		_bomb4._spriteAnimation.x = _player_START_X + 726;
		_bomb4._spriteAnimation.y  = _player_START_Y - 106;

		
		_player._spriteAnimation.init(spriteAtlas, 94, 94, 0, 10, 228); //Toshi Left idle frame
